...
<body class="bg-gray-900 text-gray-100 font-serif">
    <div class="mx-auto p-6">
        ...
        <div class="flex justify-between items-center mb-4">
            <h1 class="text-3xl font-bold text-yellow-400">📜 Dados do Personagem <?= $ficha['nomePersonagem'] ?> para batalha
            </h1>
            <!-- Botões -->
            <div class="flex gap-2">
                ...
                <a href="#"                             class="bg-yellow-500 text-black px-3 py-2 rounded-xl font-bold opacity-50 cursor-not-allowed">Batalha</a>
