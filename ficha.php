    ...
    <div class="mx-auto p-6">
        ...
        <div class="flex justify-between items-center mb-4">
            ...
            <div class="flex gap-2">
                <a href="#"                             class="bg-yellow-500 text-black px-3 py-2 rounded-xl font-bold opacity-50 cursor-not-allowed">Ficha</a>
                ...
                <button type="submit" form="formFicha"  class="bg-yellow-500 hover:bg-yellow-600 text-black px-3 py-2 rounded-xl font-bold">Salvar</button>
            ...
            <form action="fichaSalvar.php" method="POST" id="formFicha">
                ...
                <div class="grid grid-cols-12 gap-2">
                    ...
                    <div class="col-span-2 grid grid-cols-1 gap-1">
                        ...
                        <div class="col-span-2 bg-gray-800 rounded-2xl shadow-lg p-3">
                    ...
                    <div class="col-span-2 bg-gray-800 rounded-2xl shadow-lg p-3">
                        ...
                        <div class="space-y-1">
                            ...
                            foreach ($pericias as $pericia => $atributo):
                                ...
                                ?>
                                <p class="flex cursor-pointer <?= $classe ?>" data-proe="<?= $proe ?>" data-pericia="<?= $pericia ?>"
                    ...
                    <div class="col-span-3 bg-gray-800 p-4 rounded-2xl shadow-lg">
                    <h2 class="font-bold mb-2">Caracteriticas e habilidades</h2>
                        <textarea name="comentario"
                            class="w-full h-[40rem] bg-gray-700 rounded p-2"><?= htmlspecialchars($ficha['comentario']) ?></textarea>
                    </div>

                    <div class="col-span-5 grid grid-cols-4 gap-1">
                        <div class="col-span-2 bg-gray-800 p-2 rounded-2xl shadow-lg"> <h2 class="font-bold mb-2">Personalidade</h2>    <textarea name="personalidade" class="w-[17rem] h-[5rem] bg-gray-700 rounded p-1"><?= htmlspecialchars($ficha['personalidade']) ?></textarea> </div>
                        <div class="col-span-2 bg-gray-800 p-2 rounded-2xl shadow-lg"> <h2 class="font-bold mb-2">Ideais</h2>           <textarea name="ideais"        class="w-[17rem] h-[5rem] bg-gray-700 rounded p-1"><?= htmlspecialchars($ficha['ideais']) ?></textarea> </div>
                        <div class="col-span-2 bg-gray-800 p-2 rounded-2xl shadow-lg"> <h2 class="font-bold mb-2">Ligações</h2>         <textarea name="ligacoes"      class="w-[17rem] h-[5rem] bg-gray-700 rounded p-1"><?= htmlspecialchars($ficha['ligacoes']) ?></textarea> </div>
                        <div class="col-span-2 bg-gray-800 p-2 rounded-2xl shadow-lg"> <h2 class="font-bold mb-2">Defeitos</h2>         <textarea name="defeitos"      class="w-[17rem] h-[5rem] bg-gray-700 rounded p-1"><?= htmlspecialchars($ficha['defeitos']) ?></textarea> </div>
                        <div class="bg-gray-800 rounded-2xl shadow-lg p-3"><label class="block font-semibold mb-1">Nome         </label><input type="text"      name="nomePersonagem"                               value="<?= $ficha['nomePersonagem'] ?? '' ?>"           class="w-full p-2 rounded bg-gray-700 text-white"></div>
                        <div class="bg-gray-800 rounded-2xl shadow-lg p-3"><label class="block font-semibold mb-1">Classe       </label><input type="text"      name="classe"                                       value="<?= $ficha['classe'] ?? '' ?>"                   class="w-full p-2 rounded bg-gray-700 text-white"></div>
                        <div class="bg-gray-800 rounded-2xl shadow-lg p-3"><label class="block font-semibold mb-1">Nível        </label><input type="number"    name="nivel"                                        value="<?= $ficha['nivel'] ?? '' ?>"                    class="w-full p-2 rounded bg-gray-700 text-white text-center"></div>
                        <div class="bg-gray-800 rounded-2xl shadow-lg p-3"><label class="block font-semibold mb-1">Raça         </label><input type="text"      name="raca"                                         value="<?= $ficha['raca'] ?? '' ?>"                     class="w-full p-2 rounded bg-gray-700 text-white"></div>
                        <div class="bg-gray-800 rounded-2xl shadow-lg p-3"><label class="block font-semibold mb-1">Antecedente  </label><input type="text"      name="antecedente"                                  value="<?= $ficha['antecedente'] ?? '' ?>"              class="w-full p-2 rounded bg-gray-700 text-white"></div>
                        <div class="bg-gray-800 rounded-2xl shadow-lg p-3"><label class="block font-semibold mb-1">EXP          </label><input type="text"      name="exp"                                          value="<?= $ficha['exp'] ?? '' ?>"                      class="w-full p-2 rounded bg-gray-700 text-white text-center"></div>
                        <div class="bg-gray-800 rounded-2xl shadow-lg p-3"><label class="block font-semibold mb-1">BP           </label><input type="number"    name="bonusProeficiencia" id="bonusProeficiencia"   value="<?= $ficha['bonusProeficiencia'] ?? 0 ?>"        class="w-full p-2 rounded bg-gray-700 text-white text-center"></div>
                        <div class="bg-gray-800 rounded-2xl shadow-lg p-3"><label class="block font-semibold mb-1">Etica/Moral  </label><input type="text"      name="tendenciaEticaMoral"                          value="<?= $ficha['tendenciaEticaMoral'] ?? '' ?>"      class="w-full p-2 rounded bg-gray-700 text-white"></div>
                        <div class="bg-gray-800 rounded-2xl shadow-lg p-3"><label class="block font-semibold mb-1">Idade        </label><input type="text"      name="idade"                                        value="<?= $ficha['idade'] ?? '' ?>"                    class="w-full p-2 rounded bg-gray-700 text-white"></div>
                        <div class="bg-gray-800 rounded-2xl shadow-lg p-3"><label class="block font-semibold mb-1">Altura       </label><input type="text"      name="altura"                                       value="<?= $ficha['altura'] ?? '' ?>"                   class="w-full p-2 rounded bg-gray-700 text-white"></div>
                        <div class="bg-gray-800 rounded-2xl shadow-lg p-3"><label class="block font-semibold mb-1">Peso         </label><input type="text"      name="peso"                                         value="<?= $ficha['peso'] ?? '' ?>"                     class="w-full p-2 rounded bg-gray-700 text-white"></div>
                        <div class="bg-gray-800 rounded-2xl shadow-lg p-3"><label class="block font-semibold mb-1">Olhos        </label><input type="text"      name="olhos"                                        value="<?= $ficha['olhos'] ?? '' ?>"                    class="w-full p-2 rounded bg-gray-700 text-white"></div>
                        <div class="bg-gray-800 rounded-2xl shadow-lg p-3"><label class="block font-semibold mb-1">Pele         </label><input type="text"      name="pele"                                         value="<?= $ficha['pele'] ?? '' ?>"                     class="w-full p-2 rounded bg-gray-700 text-white"></div>
                        <div class="bg-gray-800 rounded-2xl shadow-lg p-3"><label class="block font-semibold mb-1">Cabelos      </label><input type="text"      name="cabelos"                                      value="<?= $ficha['cabelos'] ?? '' ?>"                  class="w-full p-2 rounded bg-gray-700 text-white"></div>
                        <div class="bg-gray-800 rounded-2xl shadow-lg p-3"><label class="block font-semibold mb-1">Jogador      </label><input type="text"      name="nomeJogador"                                  value="<?= $ficha['nomeJogador'] ?? '' ?>"              class="w-full p-2 rounded bg-gray-700 text-white"></div>
                    </div>
                </div>
            </form>
